    ...
    >
      ...
      <div className="flex flex-col h-[65%] lg:h-[55%]  justify-between absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:-translate-y-[10%]  w-full px-8 lg:py-8">
        <div className="flex justify-between w-full items-center">
          ...
          <PrimaryButton className="hidden lg:block bg-primary !p-3  hover:bg-white/10 hover:text-primary active:bg-white/10 active:text-primary text-lg text-secondary self-center">
            Explore Technology
          </PrimaryButton>
        </div>
        ...
        <div className="flex lg:flex-row flex-col w-full px-4">
          ...
          <div className="relative flex flex-col justify-center items-center w-full my-5 py-5">
          ...
          <div className="flex flex-col justify-center items-center w-full relative pb-7 lg:pb-0">
        ...
        <PrimaryButton className="lg:hidden bg-primary hover:bg-white/10 hover:text-primary active:bg-white/10 active:text-primary text-secondary self-center">
          Explore Technology
        </PrimaryButton>
        <footer
