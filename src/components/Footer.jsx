...
const Footer = ({ className }) => {
  return (
    <footer
      className={`${className} grid grid-cols-3 grid-flow-col w-full items-center absolute bottom-4 left-0 px-8 lg:px-12 lg:bottom-8 text-sm lg:text-lg font-bold`}
    >
      <a
        href="/"
